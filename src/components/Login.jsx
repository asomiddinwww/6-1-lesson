...
const Login = () => {
  ...
  const gridStyle = { width: "33.3%", height:"60px", textAlign: "center" };
      ...
      <div className="w-full flex flex-col md:flex-row items-center justify-center gap-10 max-[757px]:flex-col-reverse">
        <div className="w-full md:w-[45%] lg:w-[30%]">
          ...
          <Form onFinish={onFinish}>
            ...
            >
              <Input className="!w-full" style={{ height: 45 }} size="large" placeholder="Email" prefix={<MailOutlined />} />
            </Form.Item>
            ...
            >
              <Input.Password className="!w-full" style={{ height: 45 }} />
            </Form.Item>
            <div className="w-full flex items-center justify-between">
            <Form.Item name="remember" valuePropName="checked" label={null}>
              <Checkbox>Remember me</Checkbox>
            </Form.Item>
            <Link className="font-[600] !text-red-500" to={"/forgotpassword"}>Forgot Password</Link>
            </div>

            <Form.Item label={null}>
              <Button className="!w-full" style={{ height: 45 }} type="primary" htmlType="submit">
                Submit
              </Button>
              <div className="pt-4 w-full pb-3 flex items-center justify-center gap-2">
                <p className="font-bold">Don’t have an account?</p>
                <Link className="font-bold text-red-500" to={"/signup"}>Sign up</Link>
              </div>
            </Form.Item>

            <Divider className="!text-[12px] !text-[#646464] !pb-8" style={{ borderColor: "#313131" }}>Or login with</Divider>
